...
int main()
{
    ...
    {
        case 'C':
        printf("don vi nhiet do la C\n");
        printf("nhiet do la:");
        scanf("%f",&nhietdo);
        nhietdo = (nhietdo * 1.8) + 32;  // doi C sang F
        printf("nhiet do la %f F",nhietdo);
        break;
        case 'F':
        printf("don vi nhiet do la F");
        break;
        default:
        printf("khong phai don vi nhiet do");
    }
   // if(donvi == 'C')
   // {
